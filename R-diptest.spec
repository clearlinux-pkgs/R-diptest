...
Version  : 0.77.1
Release  : 52
URL      : https://cran.r-project.org/src/contrib/diptest_0.77-1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/diptest_0.77-1.tar.gz
...
%setup -q -n diptest
pushd ..
cp -a diptest buildavx2
popd
pushd ..
cp -a diptest buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712851005
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/diptest/libs/diptest.so
/V4/usr/lib64/R/library/diptest/libs/diptest.so
